...
<head>
    ...
    <title>403 - Access Restricted | NEXTGEN FOREX</title>
...
<body class="ng-error-bg flex flex-col justify-center items-center min-h-screen p-4 sm:p-8 text-slate-100 font-sans">
    ...
    <main class="w-full max-w-2xl my-auto text-center py-6 space-y-6">
        ...
        <div class="space-y-2 select-none">
            ...
            <div class="pt-2">
                <span
                    class="px-4 py-1.5 rounded-full bg-rose-500/20 text-rose-300 text-xs font-black uppercase tracking-[3px] border border-rose-500/40 shadow-inner inline-flex items-center gap-2">
        ...
        <div class="space-y-3 max-w-lg mx-auto">
            ...
            <div>
                <span
                    class="text-xs font-mono text-rose-400 bg-black/80 px-4 py-2 rounded-xl border border-rose-500/30 inline-flex items-center gap-2 break-all max-w-full">
        ...
        <div class="pt-4 max-w-md mx-auto flex flex-col sm:flex-row items-center justify-center gap-3">
            <a href="{{ url('/') }}"
                class="w-full sm:w-auto px-8 py-3.5 rounded-xl bg-amber-500 text-black font-black text-xs uppercase tracking-wider hover:scale-105 transition shadow-lg flex items-center justify-center gap-2 shrink-0">
        ...
        <div
            class="pt-6 border-t border-rose-500/20 flex flex-wrap items-center justify-center gap-6 text-xs text-neutral-400 font-semibold">
    ...
    <footer class="w-full max-w-5xl py-4 text-center border-t border-rose-500/20">
        <p class="text-xs text-neutral-400 font-semibold font-mono">
            NEXTGEN FOREX SECURITY GATEWAY • ALL RIGHTS RESERVED © {{ date('Y') }}
        </p>
    </footer>
