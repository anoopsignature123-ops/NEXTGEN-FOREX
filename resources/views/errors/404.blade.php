...
<body class="ng-error-bg flex flex-col justify-center items-center min-h-screen p-4 sm:p-8 text-slate-100 font-sans">
    ...
    <main class="w-full max-w-2xl my-auto text-center py-6 space-y-6">
        ...
        <div class="space-y-2 select-none">
            ...
            <div class="pt-2">
                <span
                    class="px-4 py-1.5 rounded-full bg-amber-500/20 text-amber-300 text-xs font-black uppercase tracking-[3px] border border-amber-500/40 shadow-inner inline-flex items-center gap-2">
        ...
        <div class="space-y-3 max-w-lg mx-auto">
            ...
            <div>
                <span
                    class="text-xs font-mono text-amber-400 bg-black/80 px-4 py-2 rounded-xl border border-amber-500/30 inline-flex items-center gap-2 break-all max-w-full">
        ...
        <div
            class="pt-6 border-t border-amber-500/20 flex flex-wrap items-center justify-center gap-6 text-xs text-neutral-400 font-semibold">
    ...
    <footer class="w-full max-w-5xl py-4 text-center border-t border-amber-500/20">
        <p class="text-xs text-neutral-400 font-semibold font-mono">
            NEXTGEN FOREXTRADING SYSTEM • ALL RIGHTS RESERVED © {{ date('Y') }}
        </p>
    </footer>
