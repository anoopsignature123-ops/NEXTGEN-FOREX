...
<aside class="sidebar" id="sidebar">
    ...
    <nav class="py-4 flex-1 overflow-y-auto space-y-1">
        ...
        <div
            class="nav-section-title px-5 pt-4 pb-2 mt-2 text-[10px] font-black uppercase tracking-[2px] text-amber-400/70">
        ...
        <a class='nav-item {{ request()->routeIs("admin.withdrawals*") ? "active bg-amber-500/15 text-amber-300 border-r-4 border-amber-400 font-bold shadow-lg" : "" }} flex items-center justify-between mx-3 my-0.5 px-4 py-3 rounded-xl text-sm font-medium text-neutral-300 hover:bg-amber-500/10 hover:text-amber-300 transition'
            ...
            @if($pendingWithdrawalsCount > 0)
                <span
                    class="px-2 py-0.5 rounded-full text-[10px] font-black bg-rose-500 text-white animate-pulse shadow-md border border-rose-400 shrink-0">
        ...
        <a class='nav-item {{ request()->routeIs("admin.reports.level") ? "active bg-amber-500/15 text-amber-300 border-r-4 border-amber-400 font-bold shadow-lg" : "" }} flex items-center gap-3 mx-3 my-0.5 px-4 py-2.5 rounded-xl text-xs font-medium text-neutral-300 hover:bg-amber-500/10 hover:text-amber-300 transition'
            href='{{ route("admin.reports.level") }}'>
        ...
        <a class='nav-item {{ request()->routeIs("admin.tickets*") ? "active bg-amber-500/15 text-amber-300 border-r-4 border-amber-400 font-bold shadow-lg" : "" }} flex items-center justify-between mx-3 my-0.5 px-4 py-3 rounded-xl text-sm font-medium text-neutral-300 hover:bg-amber-500/10 hover:text-amber-300 transition'
            ...
            @if($pendingTicketCount > 0)
                <span
                    class="px-2 py-0.5 rounded-full bg-rose-500 text-white font-mono font-black text-[10px] shadow-md animate-pulse">
    ...
    <div class="user-section mt-auto p-4 border-t border-amber-500/30 shrink-0 bg-neutral-950/80">
        <div class="flex items-center gap-3">
            <div
                class="w-10 h-10 rounded-full flex items-center justify-center shrink-0 bg-gradient-to-br from-amber-500 via-yellow-500 to-amber-700 text-black font-black text-sm shadow-md">
                AD
            </div>
