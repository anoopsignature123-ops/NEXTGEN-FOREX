                ...
                <tbody id="usersTableBody" class="divide-y divide-amber-500/20 text-neutral-200">
                    ...
                    <tr class="hover:bg-amber-500/10 transition user-row">
                        ...
                        <td class="p-4 min-w-[140px]">
                            ...
                            @else
                                <span class="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full bg-amber-500/20 border border-amber-500/50 text-amber-300 text-[10px] font-extrabold uppercase">
