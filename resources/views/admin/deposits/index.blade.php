    ...
    <div class="w-full space-y-6">
        ...
        <div class="ng-banner-title p-6 sm:p-8 flex flex-col lg:flex-row items-start lg:items-center justify-between gap-4">
            <div>
                ...
                <h1 class="text-2xl sm:text-3xl font-black text-gold-gradient font-heading">MEMBER DEPOSIT HISTORY AUDIT
                </h1>
                <p class="text-xs text-neutral-300 mt-1">Audit USDT (BEP20) instant deposits credited to member deposit
                    wallets.</p>
            </div>
        </div>
