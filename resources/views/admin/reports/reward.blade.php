...
@section('title', 'Reward Income Report')
    ...
    <div class="space-y-6">
        ...
        <div
            ...
            <div>
                ...
                <h1 class="text-2xl font-black font-heading text-white uppercase tracking-wider">
                    Reward Income (10%) Report
                </h1>
                <p class="text-xs text-neutral-400 mt-1">Audit 10% reward payouts earned on achieving team business
                    milestones ($1k to $50 Lacs)</p>
                </div>
                </div>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
            <div class="bg-panel p-5 rounded-2xl border border-amber-500/30 shadow-xl flex items-center gap-4">
                ...
                <div>
                    <p class="text-[11px] font-bold text-amber-400/80 uppercase">Total Rewards Distributed</p>
            ...
            <div class="bg-panel p-5 rounded-2xl border border-amber-500/30 shadow-xl flex items-center gap-4">
                ...
                <div>
                    <p class="text-[11px] font-bold text-amber-400/80 uppercase">Reward Achievers</p>
            ...
            <div class="bg-panel p-5 rounded-2xl border border-amber-500/30 shadow-xl flex items-center gap-4">
                ...
                <div>
                    <p class="text-[11px] font-bold text-amber-400/80 uppercase">Reward Share</p>
                    <p class="text-sm font-bold text-amber-300 mt-1">10% On Team Business</p>
                </div>
                </div>
                </div>
        ...
        <div class="p-3.5 rounded-2xl bg-bg/80 border border-amber-500/40 shadow-lg">
            <form action="{{ route('admin.reports.rewards') }}" method="GET"
                        ...
                        @empty
                                        <tr>
                                            <td colspan="8" class="p-8 text-center text-neutral-400 font-medium">
                                                No Reward Income records found matching your filter parameters.
                                            </td>
                                        </tr>
                                    @endforelse
                                    </tbody>
