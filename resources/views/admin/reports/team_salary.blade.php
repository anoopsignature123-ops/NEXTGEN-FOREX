...
@section('title', 'Team Salary Income Report')
    ...
    <div class="space-y-6">
        ...
        <div
            ...
            <div>
                ...
                <h1 class="text-2xl font-black font-heading text-white uppercase tracking-wider">
                    Team Salary Income Report
                </h1>
                <p class="text-xs text-neutral-400 mt-1">Audit team salary payouts earned on matching business milestones
                    ($75/15 days for 12 months)</p>
                </div>
                </div>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
            <div class="bg-panel p-5 rounded-2xl border border-amber-500/30 shadow-xl flex items-center gap-4">
                ...
                <div>
                    <p class="text-[11px] font-bold text-amber-400/80 uppercase">Total Team Salary Paid</p>
            ...
            <div class="bg-panel p-5 rounded-2xl border border-amber-500/30 shadow-xl flex items-center gap-4">
                ...
                <div>
                    <p class="text-[11px] font-bold text-amber-400/80 uppercase">Total Salary Payout Logs</p>
            ...
            <div class="bg-panel p-5 rounded-2xl border border-amber-500/30 shadow-xl flex items-center gap-4">
                <div class="w-12 h-12 rounded-xl bg-amber-500/20 border border-amber-500/40 flex items-center justify-center shrink-0">
                    <i data-lucide="calendar-range" class="w-6 h-6 text-amber-400"></i>
                </div>
                <div>
                    <p class="text-[11px] font-bold text-amber-400/80 uppercase">Duration & Tenure</p>
                    <p class="text-sm font-bold text-emerald-400 mt-1">15-Day Cycles (12 Months)</p>
                </div>
                </div>
                </div>
        ...
        <div class="p-3.5 rounded-2xl bg-bg/80 border border-amber-500/40 shadow-lg">
            <form action="{{ route('admin.reports.team-salary') }}" method="GET"
                        ...
                        @forelse($logs as $log)
                            <tr class="hover:bg-amber-500/10 transition">
                                ...
                                <td class="p-4">
                                    ...
                                    @else
                                        <span class="text-neutral-500 italic text-xs">Deleted Member</span>
                                    @endif
                                </td>
                                <td class="p-4">
                        ...
                        @empty
                                        <tr>
                                            <td colspan="8" class="p-8 text-center text-neutral-400 font-medium">
                                                No Team Salary Income records found matching your filter parameters.
                                            </td>
                                        </tr>
                                    @endforelse
                                    </tbody>
