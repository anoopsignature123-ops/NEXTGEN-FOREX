...
@section('title', '24H Special Bonus Report')
...
@section('content')
    <div class="space-y-6">
        ...
        <div
            ...
            <div>
                ...
                <h1 class="text-2xl font-black font-heading text-white uppercase tracking-wider">
                    24 Hours Special Bonus Report
                </h1>
                <p class="text-xs text-neutral-400 mt-1">Track special booster bonuses earned by members completing 5 direct
                    referrals within 24 hours of joining</p>
                </div>
                </div>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
            <div class="bg-panel p-5 rounded-2xl border border-amber-500/30 shadow-xl flex items-center gap-4">
                <div class="w-12 h-12 rounded-xl bg-amber-500/20 border border-amber-500/40 flex items-center justify-center shrink-0">
                    <i data-lucide="gift" class="w-6 h-6 text-amber-400"></i>
                </div>
                <div>
                    <p class="text-[11px] font-bold text-amber-400/80 uppercase">Total Bonus Distributed</p>
            ...
            <div class="bg-panel p-5 rounded-2xl border border-amber-500/30 shadow-xl flex items-center gap-4">
                ...
                <div>
                    <p class="text-[11px] font-bold text-amber-400/80 uppercase">Achievers Count</p>
            ...
            <div class="bg-panel p-5 rounded-2xl border border-amber-500/30 shadow-xl flex items-center gap-4">
                ...
                <div>
                    <p class="text-[11px] font-bold text-amber-400/80 uppercase">Time Window</p>
                    <p class="text-sm font-bold text-amber-300 mt-1">24 Hours Joining Limit</p>
                </div>
                </div>
                </div>
        ...
        <div class="p-3.5 rounded-2xl bg-bg/80 border border-amber-500/40 shadow-lg">
            <form action="{{ route('admin.reports.bonus') }}" method="GET"
                        ...
                        @empty
                                        <tr>
                                            <td colspan="8" class="p-8 text-center text-neutral-400 font-medium">
                                                No 24H Special Bonus records found matching your filter parameters.
                                            </td>
                                        </tr>
                                    @endforelse
                                    </tbody>
