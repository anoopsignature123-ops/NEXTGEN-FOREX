    ...
    <div class="space-y-6">
        ...
        <div
            ...
            <div>
                ...
                <p class="text-xs text-neutral-400 mt-1">Track and monitor all daily return on investment yields distributed
                    across active contracts</p>
                </div>
                </div>
        ...
        <div class="p-3.5 rounded-2xl bg-bg/80 border border-amber-500/40 shadow-lg">
            <form action="{{ route('admin.reports.roi') }}" method="GET"
