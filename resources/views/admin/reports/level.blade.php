...
@section('title', 'Global Level Income (10 Levels) Audit')
    ...
    <div class="space-y-6">
        ...
        <div
            ...
            <div>
                <div class="flex items-center gap-2 text-xs font-semibold text-amber-400 uppercase tracking-widest mb-1">
                    ...
                    <span>Admin Income Payout Audit</span>
                </div>
                <h1 class="text-2xl font-black font-heading text-white uppercase tracking-wider">
                    Global Level Income (10 Levels) Audit Log
                </h1>
                <p class="text-xs text-neutral-400 mt-1">Audit platform-wide 10-tier level income distributions (L1: 20%,
                    L2: 10%, L3: 5%, L4: 4%, L5: 3%, L6-8: 2%, L9-10: 1%)</p>
                </div>
                </div>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
            <div class="bg-panel p-5 rounded-2xl border border-amber-500/30 shadow-xl flex items-center gap-4">
                ...
                <div>
                    <p class="text-[11px] font-bold text-amber-400/80 uppercase">Total Level Income Paid</p>
            ...
            <div class="bg-panel p-5 rounded-2xl border border-amber-500/30 shadow-xl flex items-center gap-4">
                ...
                <div>
                    <p class="text-[11px] font-bold text-amber-400/80 uppercase">Total Payout Logs</p>
            ...
            <div class="bg-panel p-5 rounded-2xl border border-amber-500/30 shadow-xl flex items-center gap-4">
                ...
                <div>
                    <p class="text-[11px] font-bold text-amber-400/80 uppercase">Level Structure</p>
                    <p class="text-sm font-bold text-emerald-400 mt-1">10 Levels Deep</p>
                </div>
                </div>
                </div>
        ...
        <div class="p-3.5 rounded-2xl bg-bg/80 border border-amber-500/40 shadow-lg">
            <form action="{{ route('admin.reports.level') }}" method="GET"
