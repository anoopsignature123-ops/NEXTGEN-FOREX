...
@section('title', 'Direct Salary Income Report')
    ...
    <div class="space-y-6">
        ...
        <div
            ...
            <div>
                ...
                <h1 class="text-2xl font-black font-heading text-white uppercase tracking-wider">
                    Direct Salary Income Report
                </h1>
                <p class="text-xs text-neutral-400 mt-1">Audit daily salary payouts earned based on direct business volume
                    tiers (365 Days Duration)</p>
                </div>
                </div>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
            <div class="bg-panel p-5 rounded-2xl border border-amber-500/30 shadow-xl flex items-center gap-4">
                ...
                <div>
                    <p class="text-[11px] font-bold text-amber-400/80 uppercase">Total Direct Salary Paid</p>
            ...
            <div class="bg-panel p-5 rounded-2xl border border-amber-500/30 shadow-xl flex items-center gap-4">
                ...
                <div>
                    <p class="text-[11px] font-bold text-amber-400/80 uppercase">Payout Terms</p>
                    <p class="text-sm font-bold text-emerald-400 mt-1">365 Days Daily Payouts</p>
                </div>
                </div>
                </div>
        ...
        <div class="p-3.5 rounded-2xl bg-bg/80 border border-amber-500/40 shadow-lg">
            <form action="{{ route('admin.reports.direct-salary') }}" method="GET"
                        ...
                        @empty
                                        <tr>
                                            <td colspan="8" class="p-8 text-center text-neutral-400 font-medium">
                                                No Direct Salary Income records found matching your filter parameters.
                                            </td>
                                        </tr>
                                    @endforelse
                                    </tbody>
