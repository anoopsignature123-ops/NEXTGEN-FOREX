    ...
    <div class="space-y-6">
        ...
        <div
            ...
            <div>
                ...
                <p class="text-xs text-neutral-400 mt-1">Monitor team matching and level commission distributions across
                    member network structures</p>
            </div>
        </div>
        ...
        <div class="p-3.5 rounded-2xl bg-bg/80 border border-amber-500/40 shadow-lg">
            <form action="{{ route('admin.reports.matching') }}" method="GET"
                                    ...
                                    @if($log->user && $log->user->sponsor)
                                        <a href="{{ route('admin.users.show', $log->user->sponsor->id) }}" class="group block">
                                            <div class="font-bold text-neutral-200 group-hover:text-amber-400 transition text-xs">
                                                {{ $log->user->sponsor->name }}</div>
                                            <div class="text-[11px] text-amber-400/80 font-mono">
                                                {{ $log->user->sponsor->referral_code }}</div>
                                        </a>
                                    @else
