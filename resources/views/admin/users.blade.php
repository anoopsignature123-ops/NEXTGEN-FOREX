...
@section('content')
    <!-- Header Banner -->
    <div
        class="p-6 rounded-2xl bg-gradient-to-r from-amber-950 via-neutral-900 to-black border border-amber-500/30 shadow-xl flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        <div>
            ...
            <p class="text-xs text-neutral-400 mt-1">Manage platform members, binary legs ratio (50:50), active packages,
                and total business.</p>
            </div>
        ...
        <div class="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
            ...
            <div class="flex flex-wrap items-center gap-3 w-full md:w-auto">
                <div class="relative flex-1 md:w-64">
                    ...
                    <input type="text" id="userSearchInput" placeholder="Search User ID or Name..."
                        class="w-full pl-9 pr-4 py-2 rounded-xl bg-bg border border-amber-500/30 text-xs text-white focus:outline-none focus:border-amber-400"
                        oninput="filterUserTable()">
                    </div>
                <select id="packageFilter"
                    class="px-3 py-2 rounded-xl bg-bg border border-amber-500/30 text-xs text-amber-400 font-bold focus:outline-none"
            ...
            <table class="w-full text-left text-sm" id="userTable">
                ...
                <tbody class="divide-y divide-border text-neutral-300" id="userTableBody">
                    <tr class="user-row hover:bg-border/30 transition">
                        ...
                        <td class="p-3"><span class="px-2.5 py-1 rounded bg-amber-500/10 text-amber-400 font-bold text-xs">12
                                Directs</span></td>
                        <td class="p-3 user-pkg"><span class="px-2.5 py-1 rounded bg-emerald-500/20 text-emerald-400 font-bold text-xs">Package
                                5
                                ($5,000+)</span></td>
                        ...
                        <td class="p-3"><button
                                class="px-3 py-1 rounded-lg bg-amber-500/10 text-amber-400 text-xs font-bold hover:bg-amber-500/20">View
                                Tree</button></td>
                        </tr>
                        <tr class="user-row hover:bg-border/30 transition">
                        ...
                        <td class="p-3"><span class="px-2.5 py-1 rounded bg-amber-500/10 text-amber-400 font-bold text-xs">8
                                Directs</span></td>
                        <td class="p-3 user-pkg"><span class="px-2.5 py-1 rounded bg-emerald-500/20 text-emerald-400 font-bold text-xs">Package
                                4
                                ($1,000)</span></td>
                        ...
                        <td class="p-3"><span class="px-2.5 py-1 rounded bg-amber-500/10 text-amber-400 font-bold text-xs">5
                                Directs</span></td>
                        <td class="p-3 user-pkg"><span class="px-2.5 py-1 rounded bg-emerald-500/20 text-emerald-400 font-bold text-xs">Package
                                3
                                ($500)</span></td>
                        ...
                        <td class="p-3"><span class="px-2.5 py-1 rounded bg-amber-500/10 text-amber-400 font-bold text-xs">15
                                Directs</span></td>
                        <td class="p-3 user-pkg"><span class="px-2.5 py-1 rounded bg-emerald-500/20 text-emerald-400 font-bold text-xs">Package
                                5
                                ($5,000+)</span></td>
                        ...
                        <td class="p-3"><span class="px-2.5 py-1 rounded bg-amber-500/10 text-amber-400 font-bold text-xs">3
                                Directs</span></td>
                        <td class="p-3 user-pkg"><span class="px-2.5 py-1 rounded bg-emerald-500/20 text-emerald-400 font-bold text-xs">Package
                                2
                                ($100)</span></td>
