...
@section('content')
    ...
    <div class="w-full space-y-6 font-sans relative">
        ...
        <div class="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-3.5 relative z-10">
            ...
            <div
                class="p-3.5 sm:p-4 rounded-2xl pdf-package-card relative overflow-hidden group flex flex-col justify-between">
            ...
            <a href="{{ route('admin.deposits.index') }}"
                ...
                <div class="flex justify-between items-center mb-3">
                    <div
                        class="w-9 h-9 rounded-xl pdf-gold-badge flex items-center justify-center font-black shrink-0 relative">
            ...
            <div class="flex items-center justify-between border-b border-amber-400/30 pb-2.5">
                <div class="flex items-center gap-2.5">
                    ...
                    <div>
                        ...
                        <p class="text-[11px] text-neutral-300">Live Payout Summaries Across All 8 Business Income Streams
                        </p>
                    </div>
                </div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                ...
                <a href="{{ route('admin.reports.roi') }}"
                    ...
                    <div class="flex justify-between items-center mb-2">
                        <span
                            class="w-6 h-6 rounded-lg pdf-gold-badge font-black text-[10px] flex items-center justify-center">1</span>
                        <span
                ...
                <a href="{{ route('admin.reports.bonus') }}"
                    ...
                    <div class="flex justify-between items-center mb-2">
                        <span
                            class="w-6 h-6 rounded-lg pdf-gold-badge font-black text-[10px] flex items-center justify-center">2</span>
                        <span
                    ...
                    <h4 class="text-xs font-extrabold text-white font-heading uppercase tracking-wide">24 Hours Special
                        Bonus
                    </h4>
                ...
                <a href="{{ route('admin.reports.direct') }}"
                    ...
                    <div class="flex justify-between items-center mb-2">
                        <span
                            class="w-6 h-6 rounded-lg pdf-gold-badge font-black text-[10px] flex items-center justify-center">3</span>
                        <span
                ...
                <a href="{{ route('admin.reports.level') }}"
                    ...
                    <div class="flex justify-between items-center mb-2">
                        <span
                            class="w-6 h-6 rounded-lg pdf-gold-badge font-black text-[10px] flex items-center justify-center">4</span>
                        <span
                ...
                <a href="{{ route('admin.reports.matching') }}"
                    ...
                    <div class="flex justify-between items-center mb-2">
                        <span
                            class="w-6 h-6 rounded-lg pdf-gold-badge font-black text-[10px] flex items-center justify-center">5</span>
                        <span
                ...
                <a href="{{ route('admin.reports.direct-salary') }}"
                    ...
                    <div class="flex justify-between items-center mb-2">
                        <span
                            class="w-6 h-6 rounded-lg pdf-gold-badge font-black text-[10px] flex items-center justify-center">6</span>
                        <span
                ...
                <a href="{{ route('admin.reports.team-salary') }}"
                    ...
                    <div class="flex justify-between items-center mb-2">
                        <span
                            class="w-6 h-6 rounded-lg pdf-gold-badge font-black text-[10px] flex items-center justify-center">7</span>
                        <span
                ...
                <a href="{{ route('admin.reports.rewards') }}"
                    ...
                    <div class="flex justify-between items-center mb-2">
                        <span
                            class="w-6 h-6 rounded-lg pdf-gold-badge font-black text-[10px] flex items-center justify-center">8</span>
                        <span
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-6 pt-4 relative z-10">
            ...
            <div class="p-6 rounded-3xl pdf-package-card space-y-4">
                ...
                <div class="overflow-x-auto">
                    <table class="w-full text-left text-xs whitespace-nowrap">
                        <thead
                            class="bg-black/80 text-amber-400 uppercase text-[10px] font-bold border-b border-amber-500/30">
                            <tr>
                                    ...
                                    <td class="p-3">
                                        <div class="space-y-0.5">
                                            <div class="flex items-center gap-1.5">
                                                <span
                                                    class="font-black text-amber-400 font-mono text-xs">{{ $ru->referral_code }}</span>
                                                <button
            ...
            <div class="p-6 rounded-3xl pdf-package-card space-y-4">
                <div class="flex items-center justify-between pb-3 border-b border-amber-500/20">
                    ...
                    <a href="{{ route('admin.deposits.index') }}"
                        class="text-xs text-amber-300 font-bold hover:underline">View All
                        &rarr;</a>
                </div>
                                        ...
                                        @if($rd->user)
                                            <a href="{{ route('admin.users.show', $rd->user->id) }}"
                                                ...
                                                <div>
                                                    ...
                                                    <span
                                                        class="text-[10px] text-amber-400 font-mono">{{ $rd->user->referral_code }}</span>
                                                </div>
                                            </a>
                                        @else
