            ...
            <div class="lg:col-span-2 bg-panel p-6 sm:p-8 shadow-2xl rounded-2xl border border-amber-500/30">
                <form action="{{ route('admin.packages.store') }}" method="POST" class="space-y-6">
                    ...
                    <div class="space-y-1.5">
                        ...
                        <input type="text" name="name" id="inputName" value="{{ old('name') }}" placeholder="e.g. PACKAGE 6"
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                        <div class="space-y-1.5">
                            <label class="text-xs font-bold text-amber-400 uppercase tracking-wider">Minimum Amount
                                ($)</label>
                            <input type="number" step="0.01" name="min_amount" id="inputMin" value="{{ old('min_amount') }}" placeholder="10.00"
                                class="w-full px-4 py-3 rounded-xl bg-bg border border-amber-500/40 text-white font-semibold text-xs focus:outline-none focus:border-amber-400"
                                required>
                            </div>
                            <div class="space-y-1.5">
                            <label class="text-xs font-bold text-amber-400 uppercase tracking-wider">Maximum Amount
                                ($)</label>
                            <input type="number" step="0.01" name="max_amount" id="inputMax" value="{{ old('max_amount') }}" placeholder="500.00"
                                class="w-full px-4 py-3 rounded-xl bg-bg border border-amber-500/40 text-white font-semibold text-xs focus:outline-none focus:border-amber-400"
                                required>
                            </div>
                            </div>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-3 gap-6">
                        <div class="space-y-1.5">
                            ...
                            <input type="number" step="0.01" name="daily_roi" id="inputRoi" value="{{ old('daily_roi') }}" placeholder="0.75"
                                class="w-full px-4 py-3 rounded-xl bg-bg border border-amber-500/40 text-white font-semibold text-xs focus:outline-none focus:border-amber-400"
                                required>
                            </div>
                            <div class="space-y-1.5">
                                <label class="text-xs font-bold text-amber-400 uppercase tracking-wider">Duration (Days)</label>
                            <input type="number" name="duration_days" id="inputDuration" value="{{ old('duration_days', 200) }}" placeholder="200"
                                class="w-full px-4 py-3 rounded-xl bg-bg border border-amber-500/40 text-white font-semibold text-xs focus:outline-none focus:border-amber-400"
                                required>
                            </div>
                            <div class="space-y-1.5">
                            ...
                            <input type="number" step="0.1" name="total_return_multiplier" id="inputMultiplier"
                                value="{{ old('total_return_multiplier', 2.0) }}" placeholder="2.0"
                                class="w-full px-4 py-3 rounded-xl bg-bg border border-amber-500/40 text-white font-semibold text-xs focus:outline-none focus:border-amber-400"
                                required>
                            </div>
                            </div>
                    ...
                    <div class="space-y-1.5">
                        ...
                        <textarea name="description" id="inputDesc" rows="3" placeholder="Package description..."
                            class="w-full px-4 py-3 rounded-xl bg-bg border border-amber-500/40 text-white font-semibold text-xs focus:outline-none focus:border-amber-400">{{ old('description') }}</textarea>
                        </div>
                    ...
                    <div class="space-y-3">
                        ...
                        <div>
                            <div id="previewName" class="text-xs font-extrabold text-neutral-300 uppercase tracking-wider">
                                NEW PACKAGE</div>
                            <h3 id="previewRange" class="text-2xl font-black text-gold-gradient font-mono mt-1">$10 - $500
                            </h3>
                            </div>
