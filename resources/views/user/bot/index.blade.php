...
@section('content')
    ...
    <div class="w-full space-y-6">
        ...
        <div
            class="p-5 sm:p-8 rounded-2xl bg-gradient-to-r from-amber-950/60 via-black to-amber-950/60 border border-amber-500/40 shadow-2xl flex flex-col lg:flex-row items-start lg:items-center justify-between gap-4 relative overflow-hidden text-left">
            ...
            <div class="space-y-1.5 z-10 text-left">
                <div class="flex items-center gap-2">
                    <span
                        class="px-2.5 py-0.5 rounded-full bg-amber-500/20 border border-amber-400/50 text-amber-300 text-[10px] font-black tracking-widest uppercase">BOT
                        OVERVIEW</span>
                    <span class="text-[10px] sm:text-[11px] text-amber-400 font-extrabold tracking-[2px] uppercase">NEXTGEN
                        QUANT TRADING SYSTEM</span>
                </div>
                <h1
                ...
                <p class="text-xs sm:text-sm text-neutral-300 max-w-2xl font-medium text-left">
                    Activate NextGen Autonomous Quant Bot to execute high-frequency crypto trading and compound your daily
                    ROI.
                </p>
            </div>
            ...
            <div class="z-10 w-full lg:w-auto flex items-center justify-start lg:justify-end shrink-0">
                @if($user->is_bot_active)
                    <div
                        class="w-full sm:w-auto px-5 py-2.5 rounded-xl bg-emerald-500/20 border border-emerald-500/60 text-emerald-300 text-xs font-black flex items-center justify-center gap-2.5 shadow-xl">
                        <div class="beacon-dot bg-emerald-400"></div>
                        <span>BOT ACTIVE (Since {{ $user->bot_activated_at?->format('M d, Y H:i') }})</span>
                    </div>
                @else
                    <div
                        class="w-full sm:w-auto px-5 py-2.5 rounded-xl bg-amber-500/20 border border-amber-500/60 text-amber-300 text-xs font-black flex items-center justify-center gap-2.5 shadow-xl">
        ...
        <div class="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-3.5">
            ...
            <div class="ng-bot-card p-4 sm:p-5 flex items-center gap-4 overflow-hidden">
                <div
                    class="w-12 h-12 rounded-2xl bg-gradient-to-br from-amber-400 to-amber-600 text-black flex items-center justify-center font-black text-xl shadow-lg shrink-0">
                    <i class="fa-solid fa-microchip"></i>
                </div>
                <div class="min-w-0 flex-1 text-left">
                    <div class="text-[11px] text-amber-400/90 font-extrabold uppercase tracking-wider truncate text-left">
                        Bot Status</div>
                    <div
                        class="text-xs sm:text-sm md:text-base font-black truncate text-left {{ $user->is_bot_active ? 'text-emerald-400' : 'text-amber-400' }}">
            ...
            <div class="ng-bot-card p-4 sm:p-5 flex items-center gap-4 overflow-hidden">
                <div
                    class="w-12 h-12 rounded-2xl bg-gradient-to-br from-emerald-400 to-teal-600 text-black flex items-center justify-center font-black text-xl shadow-lg shrink-0">
                    <i class="fa-solid fa-chart-line"></i>
                </div>
                <div class="min-w-0 flex-1 text-left">
                    <div class="text-[11px] text-emerald-400/90 font-extrabold uppercase tracking-wider truncate text-left">
                        Daily ROI Yield</div>
                    <div class="text-xs sm:text-sm md:text-base font-black text-white font-mono truncate text-left">0.50% -
                        1.50%</div>
                </div>
            </div>
            ...
            <div class="ng-bot-card p-4 sm:p-5 flex items-center gap-4 overflow-hidden">
                <div
                    class="w-12 h-12 rounded-2xl bg-gradient-to-br from-yellow-400 to-amber-600 text-black flex items-center justify-center font-black text-xl shadow-lg shrink-0">
                    <i class="fa-solid fa-wallet"></i>
                </div>
                <div class="min-w-0 flex-1 text-left">
                    <div class="text-[11px] text-amber-300/90 font-extrabold uppercase tracking-wider truncate text-left">
                        Earning Wallet</div>
                    <div class="text-xs sm:text-sm md:text-base font-black text-amber-300 font-mono truncate text-left">
                        ${{ number_format($user->earning_wallet, 2) }}</div>
                </div>
            </div>
            ...
            <div class="ng-bot-card p-4 sm:p-5 flex items-center gap-4 overflow-hidden">
                <div
                    class="w-12 h-12 rounded-2xl bg-gradient-to-br from-cyan-400 to-blue-600 text-black flex items-center justify-center font-black text-xl shadow-lg shrink-0">
                    <i class="fa-solid fa-server"></i>
                </div>
                <div class="min-w-0 flex-1 text-left">
                    <div class="text-[11px] text-cyan-400/90 font-extrabold uppercase tracking-wider truncate text-left">
                        Exchange Nodes</div>
        ...
        <div class="grid grid-cols-1 bot-cards-row gap-4 sm:gap-5">
            ...
            <div class="ng-bot-card p-5 sm:p-6 flex flex-col justify-between text-left">
                <div class="text-left">
                    <div
                        class="w-12 h-12 rounded-2xl bg-gradient-to-br from-amber-400 to-yellow-500 text-black flex items-center justify-center mb-4 shadow-lg text-xl">
                    ...
                    <p class="text-xs text-neutral-300 leading-relaxed font-normal text-left">
                        Our Quant Bot continuously scans sub-second liquidity orderbooks across Binance, OKX, and Bybit to
                        capture arbitrage opportunities instantly.
                    </p>
                </div>
                <div
                    class="mt-5 pt-3.5 border-t border-amber-500/20 text-xs text-amber-400 font-mono font-bold flex items-center gap-2 text-left">
            ...
            <div class="ng-bot-card p-5 sm:p-6 flex flex-col justify-between text-left">
                <div class="text-left">
                    <div
                        class="w-12 h-12 rounded-2xl bg-gradient-to-br from-emerald-400 to-teal-500 text-black flex items-center justify-center mb-4 shadow-lg text-xl">
                    ...
                    <p class="text-xs text-neutral-300 leading-relaxed font-normal text-left">
                        Once triggered, the Bot manages position sizing and risk profiles automatically, compounding your
                        daily yield 24/7 up to your 2X return cap.
                    </p>
                </div>
                <div
                    class="mt-5 pt-3.5 border-t border-emerald-500/20 text-xs text-emerald-400 font-mono font-bold flex items-center gap-2 text-left">
            ...
            <div class="ng-bot-card p-5 sm:p-6 flex flex-col justify-between text-left">
                <div class="text-left">
                    <div
                        class="w-12 h-12 rounded-2xl bg-gradient-to-br from-yellow-400 to-amber-600 text-black flex items-center justify-center mb-4 shadow-lg text-xl">
                    ...
                    <p class="text-xs text-neutral-300 leading-relaxed font-normal text-left">
                        Activation requires only one simple click on our Live Trading Terminal. No re-subscriptions or
                        manual server configuration required.
                    </p>
                </div>
                <div
                    class="mt-5 pt-3.5 border-t border-amber-500/20 text-xs text-amber-300 font-mono font-bold flex items-center gap-2 text-left">
            ...
            <div class="flex items-start sm:items-center gap-5 sm:gap-6 z-10 w-full md:w-auto text-left">
                ...
                <div class="space-y-1.5 text-left min-w-0 flex-1 pl-1">
                    <div class="flex items-center gap-2 text-left">
                        ...
                        @if($user->is_bot_active)
                            <span
                                class="px-2.5 py-0.5 rounded-full bg-emerald-500/20 border border-emerald-500/60 text-emerald-400 text-[10px] font-extrabold uppercase flex items-center gap-1.5">
                                <div class="beacon-dot bg-emerald-400"></div>
                                BOT ACTIVE
                            </span>
                        @else
                            <span
                                class="px-2.5 py-0.5 rounded-full bg-amber-500/20 border border-amber-500/60 text-amber-400 text-[10px] font-extrabold uppercase">
                                ⚡ PENDING ACTIVATION
                            </span>
                        @endif
                    </div>
                    ...
                    <p class="text-xs text-neutral-300 font-normal max-w-xl text-left">
                        ...
                        @else
                            Open the interactive TradingView market terminal, monitor real-time crypto charts, select trading
                            pairs, and launch your bot.
                        @endif
                    </p>
                </div>
            </div>
