    ...
    <div class="w-full space-y-6 font-sans">
        ...
        <div
            ...
            <div>
                ...
                <p class="text-xs text-neutral-400 mt-1">Track status, net received amounts, 10% deductions and USDT BEP20
                    destination addresses</p>
                </div>

                <div class="flex items-center gap-3">
                <a href="{{ route('user.withdrawals.index') }}"
                    class="px-4 py-2.5 rounded-xl bg-gradient-to-r from-amber-400 to-amber-500 hover:from-amber-300 hover:to-amber-400 text-black font-black text-xs uppercase tracking-wider transition shadow-md flex items-center gap-2">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div class="bg-panel p-5 rounded-2xl border border-amber-500/30 shadow-xl flex items-center gap-4">
                ...
                <div>
                    ...
                    <p class="text-2xl font-black text-emerald-400 font-mono mt-0.5">${{ number_format($totalNetPaid, 2) }}
                    </p>
                    </div>
                    </div>
                    </div>
        ...
        <div class="bg-panel p-6 shadow-2xl rounded-2xl border border-amber-500/30 space-y-6">
            ...
            <div class="p-3.5 rounded-2xl bg-bg/80 border border-amber-500/40 shadow-lg">
                <form action="{{ route('user.withdrawals.history') }}" method="GET"
                    ...
                    <div class="flex-1 min-w-[200px]">
                        ...
                        <div class="relative">
                            ...
                            <input type="text" name="search" value="{{ request('search') }}" placeholder="WD-..., USDT address"
