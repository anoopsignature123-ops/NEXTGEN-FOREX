    ...
    <div class="w-full space-y-6">
        ...
        <div class="ng-banner-title p-6 sm:p-8 flex flex-col lg:flex-row items-start lg:items-center justify-between gap-4">
            <div>
                ...
                <p class="text-xs text-neutral-300 mt-1">Transfer the exact amount to fund your deposit wallet instantly via
                    iPaymentWallet gateway.</p>
            </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div
                class="bg-panel p-6 shadow-2xl rounded-2xl border border-amber-500/30 space-y-5 flex flex-col justify-between">
                <div class="space-y-4">

                    <!-- Important Warning Alert -->
                    <div
                        class="p-4 rounded-xl bg-amber-500/10 border border-amber-500/30 text-xs text-amber-300 flex items-start gap-2">
                        <i data-lucide="alert-triangle" class="w-4 h-4 text-amber-400 shrink-0 mt-0.5"></i>
                        <div>
                            <strong class="font-bold">Important:</strong> Only send USDT BEP-20 (Binance Smart Chain) to
                            this address. Other cryptocurrencies cannot be recovered.
                        </div>
                    </div>

                    <div class="text-center space-y-2">
                        <span class="text-xs text-neutral-400 uppercase tracking-wider font-bold">Send Exactly</span>
                        <h2 class="text-3xl font-black text-gold-gradient">${{ number_format($deposit->amount, 2) }} USDT
                        </h2>
                        <span
                            class="inline-block px-3 py-1 rounded-full bg-black border border-amber-500/40 text-amber-300 text-xs font-mono font-bold">
                    ...
                    <!-- QR Code Box -->
                    <div
                        class="flex flex-col items-center justify-center p-4 bg-bg rounded-2xl border border-amber-500/30 text-center">
                        @php
                    ...
                    <div class="space-y-1.5">
                        <label class="text-xs font-bold text-amber-400 uppercase tracking-wider block">Wallet
                            Address:</label>
                        <div
                            ...
                            <span
                                id="walletAddressText">{{ $deposit->wallet_address ?? 'Generating payment address...' }}</span>
                    ...
                    <div class="flex items-center justify-between p-4 rounded-xl bg-bg border border-amber-500/20">
                        <div class="text-rose-400 font-bold text-xs flex items-center gap-1.5" id="paymentTimer">
                            <i data-lucide="clock" class="w-4 h-4 text-rose-400"></i> Expires in: <span id="countdown"
                                class="font-mono text-sm font-black">29:59</span>
                        </div>
            ...
            <div
                ...
                <div class="space-y-5">
                    ...
                    <ul class="space-y-4 text-xs text-neutral-300 leading-relaxed">
                        <li class="flex items-start gap-3">
                            <span
                                class="w-6 h-6 rounded-full bg-amber-500/20 border border-amber-500/40 text-amber-300 font-bold flex items-center justify-center shrink-0">1</span>
                            <span>Scan the QR code using your crypto wallet app (Trust Wallet, Binance, MetaMask, etc.) or
                                copy the BEP20 address.</span>
                        </li>
                        <li class="flex items-start gap-3">
                            <span
                                class="w-6 h-6 rounded-full bg-amber-500/20 border border-amber-500/40 text-amber-300 font-bold flex items-center justify-center shrink-0">2</span>
                            <span>Open your wallet, choose <b>"Send"</b> or <b>"Withdraw"</b>, and select network <b>BEP20
                                    (Binance Smart Chain)</b>.</span>
                        </li>
                        <li class="flex items-start gap-3">
                            <span
                                class="w-6 h-6 rounded-full bg-amber-500/20 border border-amber-500/40 text-amber-300 font-bold flex items-center justify-center shrink-0">3</span>
                            <span>Input the exact payment amount: <strong
                                    class="text-emerald-400">${{ number_format($deposit->amount, 2) }} USDT</strong>.</span>
                        </li>
                        <li class="flex items-start gap-3">
                            <span
                                class="w-6 h-6 rounded-full bg-amber-500/20 border border-amber-500/40 text-amber-300 font-bold flex items-center justify-center shrink-0">4</span>
                            <span>Confirm the transfer in your wallet. This page will automatically update once the payment
                                is verified.</span>
                        </li>
                    </ul>
                ...
                <div class="pt-4">
                    <a href="{{ route('user.deposits.history') }}"
                        class="w-full py-3 rounded-xl bg-bg border border-amber-500/40 text-amber-300 hover:bg-amber-500 hover:text-black font-bold text-xs uppercase tracking-wider transition flex items-center justify-center gap-2 shadow">
