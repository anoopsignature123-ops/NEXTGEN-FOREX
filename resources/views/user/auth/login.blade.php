    ...
    <div class="space-y-6">
        ...
        <div class="ng-pkg-card p-8 border-2 border-amber-400 ng-auth-card-shadow space-y-6 relative backdrop-blur-xl">
            ...
            <form action="{{ route('user.login') }}" method="POST" class="space-y-4">
                ...
                <!-- User ID / Email Field -->
                <div>
                    <label class="block text-xs font-bold text-amber-400 uppercase mb-1.5">Referral Code / Registered
                        Email</label>
                    <div class="relative">
                ...
                <!-- Password Field -->
                <div> <label class="block text-xs font-bold text-amber-400 uppercase mb-1.5">Password</label>
                    <div class="relative">
                        <div class="absolute left-3.5 top-1/2 -translate-y-1/2 text-amber-400 pointer-events-none">
                            <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" viewBox="0 0 24 24" fill="none"
                                stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                        ...
                        <button type="button" onclick="toggleUserPassword()"
                            ...
                            <svg id="userEyeOpen" xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" viewBox="0 0 24 24"
                                fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                stroke-linejoin="round">
                                <path d="M2 12s3-7 10-7 10 7 10 7-3 7-10 7-10-7-10-7Z" />
                                <circle cx="12" cy="12" r="3" />
                            </svg>
                            <svg id="userEyeClosed" xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 hidden text-amber-300"
            ...
            <div class="text-center pt-3 border-t border-amber-500/20 flex items-center justify-between text-xs">
                <p class="text-neutral-400">
                    ...
                    <a href="{{ route('user.register') }}"
                        class="text-amber-400 font-black hover:underline ml-1">REGISTER</a>
                </p>
