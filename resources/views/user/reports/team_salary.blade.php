    ...
    <div class="space-y-6">
        ...
        <div
            ...
            <div>
                ...
                <h1 class="text-2xl font-black font-heading text-white uppercase tracking-wider">
                    My Team Salary Income
                </h1>
                <p class="text-xs text-neutral-400 mt-1">Track your 15-day recurring team salary payouts earned on matching
                    team business milestones ($75 per 15 days for 12 months)</p>
                </div>
                </div>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
            <div class="bg-panel p-5 rounded-2xl border border-amber-500/30 shadow-xl flex items-center gap-4">
                ...
                <div>
                    <p class="text-[11px] font-bold text-amber-400/80 uppercase">Total Team Salary Earned</p>
            ...
            <div class="bg-panel p-5 rounded-2xl border border-amber-500/30 shadow-xl flex items-center gap-4">
                ...
                <div>
                    <p class="text-[11px] font-bold text-amber-400/80 uppercase">Salary Payout Cycles</p>
            ...
            <div class="bg-panel p-5 rounded-2xl border border-amber-500/30 shadow-xl flex items-center gap-4">
                ...
                <div>
                    <p class="text-[11px] font-bold text-amber-400/80 uppercase">Tenure</p>
                    <p class="text-sm font-bold text-emerald-400 mt-1">15 Days for 12 Months</p>
                </div>
                </div>
                </div>
        ...
        <div class="p-3.5 rounded-2xl bg-bg/80 border border-amber-500/40 shadow-lg">
            <form action="{{ route('user.reports.team-salary') }}" method="GET"
