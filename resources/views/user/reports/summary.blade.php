    ...
    <div class="space-y-6">
        ...
        <div
            ...
            <div>
                ...
                <p class="text-xs text-neutral-400 mt-1">Unified earnings dashboard summarizing your returns across all 8
                    NextGen Forex income streams</p>
            </div>
        ...
        <div class="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-3.5">
            ...
            <!-- 4. Level Income -->
            <a href="{{ route('user.reports.level') }}"
                class="group bg-panel p-4 rounded-2xl border border-amber-500/30 hover:border-amber-400 shadow-lg transition block">
                <div class="flex items-center justify-between mb-2">
